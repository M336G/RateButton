...
## Features
- <cj>Rate</c>/<cj>send</c> <cj>levels</c> & set their <cj>difficulty automatically</c>
- Set/suggest levels as <cj>rated only</c>, <cj>featured</c>, <cj>epic</c>, <cj>legendary</c>, or <cj>mythic</c>
- Toggle <cj>coins being verified or not</c>
- Set levels for <cj>daily</c> or <cj>weekly</c>
